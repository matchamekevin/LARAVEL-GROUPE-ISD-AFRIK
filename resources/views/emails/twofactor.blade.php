                ...
                <tr>
                    <td class="content">
                        ...
                        <div style="text-align:center;margin:12px 0 8px 0">
                            <span
                                class="code"
                                style="display:inline-block; padding:18px 32px; background:#f1f5f9; border-radius:10px; font-weight:700; font-size:32px; letter-spacing:8px; font-family:'Courier New',monospace; color:#071129; user-select:all; -webkit-user-select:all; border:2px dashed #d1d5db;"
                            >{{ $code }}</span>
                        </div>
                        <p class="copy-help" style="text-align:center;color:#6b7280;font-size:13px;">Appuyez longuement sur le code ci-dessus pour le sélectionner, puis <strong>Copier</strong> et collez-le dans l'application.</p>
