...
Route::middleware(['auth:sanctum', 'isAdmin'])->group(function () {
    ...
    Route::patch('/utilisateurs/{id}/restore', [UserController::class, 'restore']);
    Route::post('/utilisateurs/admin-adjoint', [UserController::class, 'storeAdminAdjoint'])->middleware('isSuperAdmin');
